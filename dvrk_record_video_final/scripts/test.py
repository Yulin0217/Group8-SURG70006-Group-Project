...
if __name__ == '__main__':
    ...
    offsets = [
    [0.0561155,   0.0623496,   -0.142415],  
    [0.0519362,  -0.0220702,   -0.153935],
    [0.0243341,   0.0295819,   -0.159358], 
    [-0.0162265,  0.00951003,   -0.162824], 
    [-0.00352964,  -0.0579063,   -0.153193],
    ]   

    offset_1 = numpy.array(offsets[1]) - numpy.array(offsets[0])
    offset_2 = numpy.array(offsets[2]) - numpy.array(offsets[1])
    offset_3 = numpy.array(offsets[3]) - numpy.array(offsets[2])
    offset_4 = numpy.array(offsets[4]) - numpy.array(offsets[3])
    # offset_to1 = numpy.array([-0.00835179,   0.0186402,   -0.108368]) - numpy.array([0.0125755,  -0.0475104,   -0.183427])
    ...
    print('initial: ', initial_cartesian)

    # application.run_set_point(0.0561155, 0.0623496, -0.142415, steps, dt)


    application.run_move_cp_steps(offset_1[0], offset_1[1], offset_1[2], steps, dt)
    application.run_move_cp_steps(offset_2[0], offset_2[1], offset_2[2], steps, dt)
    application.run_move_cp_steps(offset_3[0], offset_3[1], offset_3[2], steps, dt)
    application.run_move_cp_steps(offset_4[0], offset_4[1], offset_4[2], steps, dt)
    
    application.run_set_point(0.0561155, 0.0623496, -0.142415, steps, dt)


        # # for offset in offsets:
    # #     offset_x, offset_y, offset_z = offset  # Unpack the x, y, z offsets
    # #     pose = application.run_read_pose()
    # #     print('Pose', pose)
    ...
    #     offset_x, offset_y, offset_z = offset_diff
    #     application.run_move_cp_steps(offset_x, offset_y, offset_z, steps, dt)

    # application.run_set_point(offset_0[0], offset_0[1], offset_0[2])
    ...
    # numpy.save('dvrk_pose/pose_30.npy', pose)
    # numpy.savetxt('dvrk_pose/pose_1.txt', pose, fmt='%f', delimiter=' ')

    # print('Saved pose:', numpy.load('dvrk_pose/pose_6.npy', allow_pickle=True))
