...
class example_application:
    ...
    def run_read_pose(self):
        ...
        return initial_cartesian_position, initial_cartesian_position.p
...
def connect_and_receive(server_address):
        # 创建一个 TCP/IP socket
...
if __name__ == '__main__':
    ...
    server_address = ('172.30.28.152', 8666)
    print(f'connecting to {server_address[0]} port {server_address[1]}', file=sys.stderr)
    sock.connect(server_address)
    ...
    #         translation_matrix = connect_and_receive(server_address) / 1000
    #         print(f"Translation matrix: {translation_matrix}", file=sys.stderr)
